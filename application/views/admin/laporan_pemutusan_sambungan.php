            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                     ...
                     <form action="<?= base_url('admin/laporan_pemutusan_sambungan') ?>" method="post">
                        <div class="col-4">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-stripe">
                            <a href="<?= base_url('admin/print_laporan/pemutusan') ?>" target="_blank" class="btn btn-secondary float-left ">Print</a>
                            <thead>
                                <tr>
                                    <th>#</th>
